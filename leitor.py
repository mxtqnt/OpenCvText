...
def ler_texto(recorte, c):
    ...
    while angulo <= 270:
        ...
        result = reader.readtext(recorte, paragraph="False", detail='False')
        ...
        for res in result:
            ...
            #cv2.putText(recorte, res[1], (top_left[0], top_left[1]-10), cv2.FONT_HERSHEY_SIMPLEX, 0.3, (255, 0, 255), 1)
            for item in result:
